...
public partial class Vendor_biddetails : System.Web.UI.Page
{
    SqlConnection cn;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        int vId = Convert.ToInt32(ddlvid.SelectedValue);
        ...
        DateTime start = dr["TR_STARTDATE"] != DBNull.Value ? Convert.ToDateTime(dr["TR_STARTDATE"]) : DateTime.MinValue;
