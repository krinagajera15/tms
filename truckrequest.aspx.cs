...
public partial class quote : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string FROM_CITY_NAME = ddlfcity.Text.Trim();
            string TO_CITY_NAME = ddltcity.Text.Trim();
            ...
            string query = "INSERT INTO TR_REQUEST (USER_NAME, FROM_CITY_NAME, TO_CITY_NAME, TR_STARTDATE, TR_ENDDATE, NO_OF_TRUCK, REMARKS) VALUES('" + USER_NAME + "','" + FROM_CITY_NAME + "','" + TO_CITY_NAME + "','" + TR_STARTDATE + "','" + TR_ENDDATE + "','" + NO_OF_TRUCK + "','" + REMARKS + "')SELECT CAST(SCOPE_IDENTITY() as int)"; 
